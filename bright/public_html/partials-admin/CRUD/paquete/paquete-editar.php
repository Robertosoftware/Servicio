...
?>">
    ...
    <label>Precio</label>
      <div class="input-group input-group-lg">
 <span class="input-group-addon" id="sizing-addon1"></span>
  <input type="number" class="form-control" name="precio" aria-describedby="sizing-addon1" value="<?php
echo $precio;                                                                                                
?>">
</div>
...
?>">
  	...
  	<div class="input-group">
  		<button type="submit" class="btn btn-info btn-lg btn2" name="paquete_editar">Cambiar datos</button>
  	</div>
      	<p>
         <a href="index-admin.php#!/Paquete">¿Deseas regresar?</a>
  	</p>
  </form>
</div>