...
<div class="jumbotron">
               <div class="container">
                       <h1><strong>EDITAR</strong> CATEGORÍA</h1>
        <div class="row">
        ...
        if($result)
        {
            while($row=mysqli_fetch_array($result)){
                ...
                <td>'.$row['descripcion'].'</td>
                 <td><a href="partials-admin/CRUD/server-crud.php?ecategoria='.$row['idcategoria'].'" class="btn btn-info">Editar</a></td>
                    <td><a href="partials-admin/CRUD/server-crud.php?dcategoria='.$row['idcategoria'].'" class="btn btn-danger">Eliminar</a></td>
                    </tr>
                ';
            }
        }
